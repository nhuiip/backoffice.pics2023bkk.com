<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="{{ route('associations.edit', $id) }}"><i class="fa fa-pencil"></i>&nbsp;
                Edit</a>
        </li>
        <li>
...
<form id="delete-form-{{ $id }}" method="post" action="{{ route('associations.destroy', $id) }}">
    @csrf
    @method('DELETE')
</form>
