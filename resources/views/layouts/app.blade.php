                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav @if (Route::is('home')) menu-active @endif"
                                        href="{{ route('home') }}">
                                ...
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav @if (Route::is('associations.*')) menu-active @endif"
                                ...
                                @if (Auth::user()->email == 'admin@pics2023bkk.com')
                                    <li class="sidebar-list">
