<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="{{ route('registrations-fee.edit', $id) }}"><i class="fa fa-pencil"></i>&nbsp; Edit</a>
        </li>
        <li>
...
<form id="delete-form-{{ $id }}" method="post" action="{{ route('registrations-fee.destroy', $id) }}">
    @csrf
    @method('DELETE')
</form>
